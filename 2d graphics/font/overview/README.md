...
- [如何用 OpenGL 绘制漂亮的矢量图，比如 SVG、文字等，特别是 OpenGL 绘制文本？](https://www.zhihu.com/question/283534952)
...
- [nothings/stb/stb_truetype.h](https://github.com/nothings/stb/blob/master/stb_truetype.h)
